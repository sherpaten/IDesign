...
export default function ServicesGrid() {
  const services = [
    ...
    { 
      ...
      desc: 'Crafting high-impact corporate identity systems, marketing collateral, and pristine vector graphics that define elite brand standards.', 
    ...
    { 
      ...
      desc: 'Assembling dynamic video cuts, professional sound design, pacing manipulation, and seamless transition effects tailored for commercial distribution.', 
